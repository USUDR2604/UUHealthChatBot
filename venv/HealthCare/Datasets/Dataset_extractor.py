...
# Connect to MongoDB
try:
    client = MongoClient("mongodb://localhost:27017/")  # Replace with your MongoDB URI if using a remote server
    ...
    print(f"Inserted {len(result.inserted_ids)} records into the 'PatientDetails' collection of the 'HealthCareDataCenter' database.")
